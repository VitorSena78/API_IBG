    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.PUT, "/api/atendimentos/*/triagem/editar").hasAnyRole("ADMIN", "ENFERMEIRA")
                ...
                .requestMatchers(HttpMethod.PUT, "/api/atendimentos/*/consulta/editar").hasAnyRole("ADMIN", "MEDICO")
